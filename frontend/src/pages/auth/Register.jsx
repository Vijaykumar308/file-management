...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            SetApiRequest(error.response.data.message);
        }
                    ...
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            <div className="text-center mb-6">
                                ...
                                { apiRequest && <div className="text-left bg-red-400 mt-6 py-2 px-4 capitalize rounded-md text-white">{apiRequest}</div> }
                            </div>
                            <div>
                                <form onSubmit={handleSubmit}> 
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 text-center">
                                            ...
                                            hover:text-indigo-700 rounded-lg  py-3 from-neutral-400 text-sm capitalize">
                                                Login
                                            </NavLink>
                                        </div>
                                    </div>
